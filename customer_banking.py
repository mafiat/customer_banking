...
def main():
    ...
    # ADD YOUR CODE HERE
    print(f"The interest earned on the savings account is: ${interest_earned:,.2f}. The updated savings account balance is: ${updated_savings_balance:,.2f}")
    ...
    # ADD YOUR CODE HERE
    print(f"The interest earned on the CD account is: ${interest_earned:,.2f}. The updated CD account balance is: ${updated_cd_balance:,.2f}")
